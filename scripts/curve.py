...
class Curves:
  ...
  def store_details(self, binary):
    ...
    # print("binary: " + str(binary.shape))
    # print("outimg: " + str(self.out_img.shape))
    self.binary = binary
  ...
  def fit(self, binary):
    ...
    #   print("curr left pix indices: "+ str(curr_left_pixels_indices))
      left_pixels_indices.append(curr_left_pixels_indices)
      right_pixels_indices.append(curr_right_pixels_indices)
       
      print("mid left : {}".format(mid_leftx))
      print("mid right: {}".format(mid_rightx))
      ...
      self.leftlane.append((mid_leftx,int((y[0]+y[1])/2)))
      self.rightlane.append((mid_rightx,int((y[0]+y[1])/2)))
    ...
    self.result = {
      'image': self.out_img,
      'leftlane': self.leftlane,
      'rightlane': self.rightlane,
