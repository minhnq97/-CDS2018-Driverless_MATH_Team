...
class LaneFilter:
    ...
    def apply_sobel_mask(self):       
        ...
        slm, slx, sly = self.scale_abs(l_mag), self.scale_abs(lx), self.scale_abs(ly)
        b = self.z.copy()
        ...
        b[(self.sobel_cond1 & self.sobel_cond2)] = 1  
        return b 